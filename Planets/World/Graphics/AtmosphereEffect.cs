...
namespace SimpleTriangle.World.Graphics
{
    ...
    public class AtmosphereEffect
    {
        ...
        /// </summary>
        public AtmosphereEffect(Device device)
        {
            m_effect = Ressources.EffectCache.Get("Shaders\\atmosphereEffect.fx");
            ...
            float fOuterRadius = Planet.AtmosphereRadius + Planet.PlanetRadiusDelta; // 50 
